...
dt_reg   = 0.02                     # sample time control system
...
for k in range(n0,n+n0):
    ...
    ydesmod[k]= 2.2174*ydesmod[k-1] + -1.6389*ydesmod[k-2] + 0.4038*ydesmod[k-3]+0.0022191*rreg[k-0]+0.0066574*rreg[k-1]+0.0066574*rreg[k-2]+0.0022191*rreg[k-3]
    ydesproc[k] = ydesmod[k]+OP_y
    
    # calc feedforward signal
    uffreg[k]= 1.4221*uffreg[k-1] + 0.81758*uffreg[k-2] + -1.5777*uffreg[k-3] + -0.44714*uffreg[k-4] + 1.1276*uffreg[k-5] + -0.34677*uffreg[k-6]+-9.6515*rreg[k-0]+-0.015587*rreg[k-1]+23.9741*rreg[k-2]+1.8004*rreg[k-3]+-22.2523*rreg[k-4]+-1.8583*rreg[k-5]+7.8563*rreg[k-6]
